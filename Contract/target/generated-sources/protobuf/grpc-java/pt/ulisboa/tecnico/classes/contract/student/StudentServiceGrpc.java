...
public final class StudentServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest,
      pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse> getListsMethod;
  ...
  public static io.grpc.MethodDescriptor<pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest,
      pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse> getListsMethod() {
    io.grpc.MethodDescriptor<pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest, pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse> getListsMethod;
    if ((getListsMethod = StudentServiceGrpc.getListsMethod) == null) {
      synchronized (StudentServiceGrpc.class) {
        if ((getListsMethod = StudentServiceGrpc.getListsMethod) == null) {
          StudentServiceGrpc.getListsMethod = getListsMethod =
              io.grpc.MethodDescriptor.<pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest, pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse.getDefaultInstance()))
              .setSchemaDescriptor(new StudentServiceMethodDescriptorSupplier("lists"))
              .build();
        }
      }
    }
  ...
  public static abstract class StudentServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void lists(pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest request,
        io.grpc.stub.StreamObserver<pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListsMethod(), responseObserver);
    }
  ...
  public static final class StudentServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<StudentServiceBlockingStub> {
    ...
    /**
     */
    public pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse lists(pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class StudentServiceFutureStub extends io.grpc.stub.AbstractFutureStub<StudentServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse> lists(
        pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final int METHODID_LISTS = 2;
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_ENROLL:
          ...
          break;
        case METHODID_LISTS:
          serviceImpl.lists((pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassRequest) request,
              (io.grpc.stub.StreamObserver<pt.ulisboa.tecnico.classes.contract.student.StudentClassServer.ListClassResponse>) responseObserver);
          break;
        default:
